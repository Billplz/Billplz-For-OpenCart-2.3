...
class ControllerExtensionPaymentBillplz extends Controller
{
    ...
    public function proceed()
    {
        ...
        $parameter = array(
            ...
            'callback_url' => $this->url->link('extension/payment/billplz/callback_ipn', '', true),
        ...
        $optional = array(
            'redirect_url' => $this->url->link('extension/payment/billplz/return_ipn', '', true),
    ...
    public function callback_ipn()
    {
        ...
        if ($order_status_id != $order_info['order_status_id']) {
            $this->model_checkout_order->addOrderHistory($orderid, $order_status_id, "Callback: " . $paydate . " URL:" . $rbody['url'], $notify = true);
        }
